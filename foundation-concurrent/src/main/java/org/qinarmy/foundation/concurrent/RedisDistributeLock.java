...
public class RedisDistributeLock implements DistributeLock, InitializingBean {
    ...
    private static final String LOCK_SCRIPT_PATTERN = "classpath:/script/redis/tasty/lock.lua";
    ...
    public RedisDistributeLock() {
        LOCK_SCRIPT = new DefaultRedisScript<>(
                ResourceUtils.extractFileText(LOCK_SCRIPT_PATTERN, getClass()), String.class);
    ...
    public RedisDistributeLock(ResourcePatternResolver resolver) throws IOException {
        ...
        Resource[] resources = resolver.getResources(LOCK_SCRIPT_PATTERN);
