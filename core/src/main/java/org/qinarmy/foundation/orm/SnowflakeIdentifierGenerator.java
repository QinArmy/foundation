...
import org.qinarmy.army.util.AnnotationUtils;
...
public class SnowflakeIdentifierGenerator implements IdentifierGenerator {
    ...
    private static long initDefaultStartTime() {
        ...
        try {
            Resource[] resources = resolver.getResources("classpath*:identifier/snowflake/snowflakeTime.properties");

            Properties properties = new Properties();
            properties.load(resources[0].getInputStream());

            String startTimeValue = properties.getProperty("org.qinarmy.foundation.snowflake.defaultStartTime");
